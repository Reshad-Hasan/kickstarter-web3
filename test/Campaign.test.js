...
beforeEach(async () => {
  ...
  // create Contract instance locally and deploy
...
describe('Campaigns', () => {
  ...
  it('should pass when manager is allowed to make payment request', async () => {
  ...
  it('should process requests', async () => {
    ...
    assert(balance > parseFloat(web3.utils.fromWei(prevBalance, 'ether')));
  });
})